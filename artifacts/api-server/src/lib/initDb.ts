...
const SEED_INCIDENTS = [
  ...
  { id: "INC-JLT-005", title: "PPE Cabinet Empty",        location: "Block N3, Floors 1–4",  severity: "high",     slaMinutes: 120, elapsed: 22,  source: "Worker Safety App",      status: "open",        assignedTech: null,       techId: null, description: "Multiple workers on Floors 1–4 of Block N3 reporting empty PPE cabinets — no high-vis vests or hard hats. Work-at-height tasks paused. No technician assigned yet.", lat: "25.0752000", lng: "55.1392000", siteId: "jlt-north", clientId: "CLT-004", activityLog: [{"time":"09:58 AM","event":"Worker reports received — 6 cabinets affected","type":"incident"},{"time":"10:00 AM","event":"Auto-classified: PPE & Hazard · High · 120 min SLA","type":"ai"}], closureNotes: null },
