...
export const mockVendorIntelligence: VendorIntelData[] = [
  {
    ...
    projectedTrend: 'up',
    recommendations: [
      { title: 'Expand scope to Business Bay', detail: 'Performance data supports extending DevelopmentX Core\'s safety scope to Business Bay cluster — projected to reduce response time by 22%.', action: 'renegotiate' },
...
export const mockKBResources: KBResource[] = [
  {
    id: 'KB-001',
    title: 'Safety Equipment Calibration Gas Top-Up Procedure',
    category: 'guide',
    description: 'Step-by-step guide to safely check, recover, and recharge calibration gas in split and central AC units.',
    estimatedTime: '25 min',
    difficulty: 'intermediate',
    tags: ['Safety Equipment', 'calibration gas', 'AC', 'Cal-Gas-410'],
    tools: ['Manifold gauge set', 'Calibration Gas cylinder (Cal-Gas-410)', 'Leak detector', 'Safety gloves & goggles', 'Torque wrench'],
    steps: [
      {
        title: 'Safety first — PPE and isolation',
        body: 'Put on safety gloves and goggles before handling any calibration gas. Isolate the AC unit at the MCB panel and confirm power is off using a voltage tester.',
        warning: 'Never work on a live system. Calibration Gas under pressure is hazardous — always isolate before connecting gauges.',
      },
      {
        ...
        tip: 'Blow a small puff of calibration gas through the hoses before connecting to the gauge to purge any air or moisture.',
      },
      {
        title: 'Record initial pressure readings',
        body: 'Switch the unit on in cooling mode and allow 5 minutes for pressures to stabilise. Record low-side and high-side readings on your job sheet. For Cal-Gas-410, normal low-side should be 65–80 PSI.',
      },
      {
      ...
      {
        title: 'Add calibration gas in liquid phase',
        body: 'With the cylinder inverted (liquid valve open), slowly open the low-side manifold valve. Add calibration gas in 30-second bursts, monitoring suction pressure. Target 70–75 PSI for Cal-Gas-410 in standard ambient conditions.',
        tip: 'Never open the high-side manifold valve while adding calibration gas — this can cause liquid slugging and compressor damage.',
      },
      {
      ...
      },
      {
        ...
        body: 'Close both manifold valves, then disconnect hoses slowly to minimise calibration gas loss. Replace service port caps. Log all pressure readings, calibration gas amount added, and any anomalies on your job sheet.',
      },
    ],
  },
  {
    id: 'KB-002',
    title: 'How to Reset a Tripped Lockout Panel',
    category: 'guide',
  ...
  {
    id: 'KB-003',
    title: 'Scaffold & Fall-Arrest Inspection — Monthly Check',
    category: 'sop',
    description: 'Standard Operating Procedure for the monthly scaffold and fall-arrest safety inspection, covering anchors, harnesses, and edge-protection components.',
  ...
  {
    id: 'KB-005',
    title: 'Diagnosing Chemical Spills — Pipe and Joint Faults',
    category: 'guide',
    description: 'How to locate, assess, and temporarily contain chemical spills from pipe joints, isolation valves, and flexible hoses in residential units.',
    estimatedTime: '15 min',
    difficulty: 'beginner',
    tags: ['plumbing', 'chemical spill', 'pipe', 'joint', 'diagnosis'],
  ...
  {
    id: 'KB-006',
    title: 'Gas Detector Unit Quarterly Service — Full Procedure',
    category: 'sop',
    description: 'Complete SOP for the quarterly service of central gas detector units including coil cleaning, oil checks, and performance verification.',
    estimatedTime: '3–4 hours',
    difficulty: 'advanced',
    tags: ['Safety Equipment', 'gas detector', 'quarterly', 'SOP', 'maintenance'],
    tools: ['Manifold gauges', 'Calibration Gas recovery unit', 'Fin comb', 'Chemical coil cleaner', 'High-pressure washer', 'Oil analysis kit', 'Multimeter'],
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Inspect the evaporator coil for ice formation, blocked fins, or calibration gas oil contamination. Check and clear the condensate drain pan and drain line — pour water to verify free-flow drainage.',
      },
      {
      ...
      },
      {
        ...
        body: 'Restore power and run the gas detector through a full start-up cycle. Record suction/discharge pressures, superheat, subcooling, leaving chilled water temperature, and compressor amps. Compare against baseline data from the last service.',
      },
      {
        title: 'Close out and update asset record',
        body: 'Complete all documentation including parts used, oil added, and performance readings. Update the asset maintenance record in the platform. Attach before/after photos of the coil condition. Notify the HSE Manager of the completed service.',
      },
    ],
  },
  {
    id: 'KB-007',
    title: 'Eyewash Station Inspection & Maintenance',
    category: 'checklist',
    description: 'Monthly inspection checklist for eyewash station systems covering motor, impeller, seals, and water chemistry equipment.',
    estimatedTime: '30 min',
    difficulty: 'beginner',
    tags: ['plumbing', 'eyewash station', 'monthly', 'checklist', 'inspection'],
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Complete the monthly inspection log with all readings, observations, and any work carried out. Flag any items requiring follow-up parts or specialist inspection to the HSE Manager.',
      },
    ],
  },
  {
  ...
  {
    id: 'KB-009',
    title: 'Eyewash Station Installation — Drain Line Setup',
    category: 'video',
    ...
    difficulty: 'intermediate',
    tags: ['Safety Equipment', 'AC installation', 'drain', 'condensate', 'video'],
  ...
  {
    id: 'KB-010',
    title: 'Understanding and Setting Safety Equipment Thermostat Setpoints',
    category: 'video',
    description: 'Video walkthrough of how to read, configure, and calibrate digital and analogue thermostats in commercial Safety Equipment systems.',
    estimatedTime: '18 min watch',
    difficulty: 'beginner',
    tags: ['Safety Equipment', 'thermostat', 'setpoints', 'controls', 'video'],
    ...
    steps: [
      ...
      },
      {
        ...
        warning: 'Do not override setpoints without a written instruction from the HSE Manager or client. Unauthorised changes can invalidate the service contract.',
      },
      {
  ...
  {
    id: 'KB-013',
    title: 'Emergency Lighting Load Test — Quarterly Procedure',
    category: 'checklist',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Inform the HSE Manager and building occupants that a generator test will take place. Confirm the test time with the control room and ensure any critical systems are prepared for a momentary transfer.',
      },
      {
  ...
  },
  {
    ...
    category: 'video',
    description: 'Video guide covering the five most common scaffold defects encountered on site, how to diagnose them, and when to escalate.',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Safety Equipment systems check',
        body: 'Verify all AC units, Fume Hoods, and exhaust fans are commissioned and operational. Check supply and extract grille positions match the design drawings. Measure supply air temperature — should be within 2°C of the design setpoint.',
      },
      {
      ...
      },
      {
        ...
        body: 'Log every defect with a photo, location reference, system category, and severity. Submit the completed defect schedule to the project manager and HSE Manager within 48 hours of the walk.',
    ...
    steps: [
      {
        ...
        warning: 'Legionellosis (Legionnaire\'s Disease) is a notifiable disease. Any suspected case must be reported immediately to the HSE Manager and, where required, to the health authority.',
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Transfer load',
        body: 'Once the generator is stable (check voltage 380–415V, frequency 49.5–50.5 Hz), manually transfer the ATS to generator supply if it has not transferred automatically. Notify the control room and HSE Manager immediately.',
      },
      {
        title: 'Monitor and log',
        body: 'Stay with the generator for the first 15 minutes of operation. Monitor fuel consumption, temperature, and voltage. Keep the HSE Manager updated every 30 minutes. Log the start time, reason, and fuel level before and after.',
      },
    ],
  },
  {
    id: 'KB-018',
    title: 'HVEyewash Station Inspection — Step-by-Step',
    category: 'video',
    description: 'Video guide for replacing air handling unit (Fume Hood) and fan coil unit (FCU) filters, covering filter grades, fitting, and disposal.',
    estimatedTime: '8 min watch',
    difficulty: 'beginner',
    tags: ['Safety Equipment', 'filter', 'Fume Hood', 'FCU', 'replacement', 'video'],
    ...
    steps: [
      {
        ...
        body: 'Check the asset record for the required filter specification — typically G4 (coarse pre-filter) or F7 (fine filter) for most commercial Fume Hoods. Using the wrong filter grade can restrict airflow or reduce air quality.',
      ...
      },
      {
        ...
        body: 'Stop the Fume Hood at the local isolator. Open the filter access panel — most panels have a quarter-turn fastener. Do not reach into the unit while it is running.',
      },
      {
      ...
      },
      {
        ...
        body: 'Insert the new filter in the correct airflow direction (arrow on the filter frame must point in the direction of airflow). Ensure the filter seats flush against all four sides with no gaps. Close and secure the access panel. Restart the Fume Hood and verify normal operation.',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        body: 'Any of the following must be reported immediately: personal injury or near-miss, structural damage, active chemical spills near electrical, fire or smoke, gas smell, hazardous chemical spill, or any fault affecting life safety systems.',
      ...
      },
      {
        ...
        body: 'Monitor the incident status in the platform. If a corrective work order has been raised, track it through to completion. If the incident is not acted on within the SLA timeframe, escalate to the HSE Manager.',
      },
    ],
  },
];
