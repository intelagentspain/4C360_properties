...
const CHAPTER_NARRATION_OPENERS: Record<string, string> = {
  ...
  projectcommand: 'ProjectCommand is where the portfolio signal becomes an owner decision. You see what changed, what is at risk, which decision matters now, and which control lane explains the action.',
...
const DEMO_CHAPTERS: DemoChapter[] = [
  ...
  },
  {
    ...
    story: 'The overview shows what changed, what is at risk, which decision matters, and the control lane that explains the next move.',
