...
const ENTRY_BRIEFINGS: Array<{
  ...
  },
  {
    ...
    body: 'The walkthrough moves from portfolio concern into project control, programme, stage gates, cost, evidence, vendor action, field proof, and resident follow-through.',
    proof: 'Every concern points to a team, blocker, artifact, and next decision.',
    question: 'Who owns the recovery path?',
    metric: '11 chapter path',
  },
  {
    icon: ShieldAlert,
    label: 'Exposure control',
    title: 'See the commercial and readiness consequence early.',
    body: 'Cost movement, gate blockers, missing evidence, vendor performance, and field execution are shown together, so the board can compare the cost of action with the cost of delay.',
...
const DEMO_ACTS: DemoAct[] = [
  ...
  },
  {
    ...
    promise: 'One handover risk becomes project, programme, gate, cost, and evidence decisions.',
    chapterIds: ['projectcommand', 'programme', 'stagegates', 'cost', 'evidence'],
  },
  {
...
const INTRO_SECTION_SYNC_MS: Record<string, { sectionId: string; atMs: number }[]> = {
  ...
  stagegates: [
    { sectionId: 'blocked-gate', atMs: 0 },
    { sectionId: 'evidence-gaps', atMs: 25_000 },
    { sectionId: 'recovery-actions', atMs: 57_000 },
  ],
};
...
function getTimelineCues(chapterId: string, segmentId: string, estimatedDurationMs: number, beats: DemoSpotlightBeat[]): DemoTimelineCue[] {
  ...
  const timelineMap: Record<string, DemoTimelineCue[]> = {
    ...
    'stagegates:intro': [
      ...
      spotlightCue(3000, 'project-stage-gates', { left: 8, top: 12, width: 84, height: 74 }, 7000),
      scrollCue(9200, 'project-stage-active-blockers'),
      flashCue(10000, 'project-stage-active-blockers', { left: 6, top: 40, width: 20, height: 14 }, 1600),
      flashCue(12400, 'project-stage-pending-review', { left: 28, top: 40, width: 20, height: 14 }, 1600),
      flashCue(14800, 'project-stage-evidence-gaps-metric', { left: 50, top: 40, width: 20, height: 14 }, 1600),
      flashCue(17200, 'project-stage-avg-completion', { left: 72, top: 40, width: 20, height: 14 }, 1800),
      pulseCue(19000, 'project-stage-review-blockers', { left: 68, top: 14, width: 20, height: 9 }, 1900),
      spotlightCue(22400, 'project-stage-ai-blockers-modal', { left: 66, top: 4, width: 32, height: 90 }, 11500),
      scrollCue(38200, 'project-stage-ai-blocker-recommendation'),
      spotlightCue(38400, 'project-stage-ai-blocker-recommendation', { left: 68, top: 56, width: 28, height: 28 }, 9000),
      pulseCue(51800, 'project-stage-ai-blocker-action', { left: 70, top: 68, width: 24, height: 9 }, 1700),
      scrollCue(57400, 'project-stage-proof-loop'),
      spotlightCue(58000, 'project-stage-proof-loop', { left: 8, top: 20, width: 84, height: 38 }, 9000),
      flashCue(62800, 'project-stage-proof-pack-button', { left: 67, top: 46, width: 24, height: 9 }, 1700),
      scrollCue(70400, 'project-stage-action-queue'),
      spotlightCue(70800, 'project-stage-action-queue', { left: 8, top: 36, width: 84, height: 36 }, 6500),
      scrollCue(80500, 'projectcommand-tabs'),
      spotlightCue(81200, 'cost-control-tab', { left: 58, top: 68, width: 28, height: 12 }, 5200),
      { atMs: 87780, type: 'chapterPause' },
    ],
    'cost:intro': [
      scrollCue(0, 'project-cost-summary'),
      spotlightCue(3000, 'project-cost-summary', { left: 8, top: 12, width: 84, height: 34 }, 11500),
      flashCue(15400, 'project-cost-variance-card', { left: 50, top: 33, width: 23, height: 14 }, 2300),
      { atMs: 17600, type: 'demoAction', actionId: 'focus-cost-variance-card' },
      pulseCue(19800, 'project-cost-variance-ai-button', { left: 67, top: 38, width: 5, height: 5 }, 1300),
      { atMs: 20000, type: 'demoAction', actionId: 'open-cost-variance-ai' },
      spotlightCue(22600, 'ai-insight-panel', { left: 68, top: 8, width: 30, height: 84 }, 18000),
      spotlightCue(74000, 'evidence-control-tab', { left: 58, top: 68, width: 28, height: 12 }, 7000),
...
function getDemoActionAnchor(actionId: string): HotspotTarget | null {
  const actionAnchors: Record<string, HotspotTarget> = {
    ...
    'open-cost-variance-ai': {
      anchor: 'project-cost-variance-ai-button',
      fallback: { left: 67, top: 38, width: 5, height: 5 },
    },
    'focus-cost-variance-card': {
