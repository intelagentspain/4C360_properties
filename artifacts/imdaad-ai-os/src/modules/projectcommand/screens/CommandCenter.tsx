...
const kpis = [
  ...
  { label: 'Days to Handover', value: project.daysToHandover, tone: '#EEF3FA' },
...
export function CommandCenter({ goTo }: { goTo: (screen: ProjectCommandScreen) => void }) {
  ...
  return (
    <div className="custom-scrollbar h-full overflow-x-hidden overflow-y-auto px-5 py-4 text-[#EEF3FA]">
      <section className="mb-4 rounded-xl border border-[rgba(46,127,255,0.18)] bg-[rgba(17,32,64,0.78)] p-4">
        <div className="grid gap-5 xl:grid-cols-[110px_1fr_330px] xl:items-center">
          ...
          <div className="border-l-2 border-[#00B894] pl-5">
            ...
            <h2 className="max-w-5xl text-[18px] font-black leading-6" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>{aiContent.healthScore.topThreat}</h2>
            <p className="mt-2 text-[12px] leading-5 text-[#B8C7DB]">{aiContent.healthScore.recommendedAction}</p>
          </div>
          <div className="grid grid-cols-3 gap-2">
            ...
            <div className="col-span-3 rounded-xl border border-[rgba(46,127,255,0.18)] bg-[#0A1628]/70 px-3 py-2"><Sparkline /></div>
          </div>
        </div>
      </section>
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.5fr)_330px]">
        <div className="space-y-4">
          ...
          <section className="rounded-xl border border-[rgba(46,127,255,0.18)] bg-[rgba(17,32,64,0.78)] p-4">
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-base font-black" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Cost Intelligence</h3>
        ...
        <div className="space-y-4">
          <section className="rounded-xl border border-[rgba(46,127,255,0.18)] bg-[rgba(17,32,64,0.78)] p-4">
            <h3 className="mb-3 text-base font-black" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Live Site Map</h3>
            <SiteMapSVG />
          </section>
          <section className="rounded-xl border border-[rgba(46,127,255,0.18)] bg-[rgba(17,32,64,0.78)] p-4">
            <div className="mb-3 flex items-center justify-between">
      ...
      <div className="mt-4 flex items-center gap-2 text-[11px] text-[#7A94B4]"><CalendarClock size={13} /> Danube Properties · Lawnz Residences · AED 280M · Target handover 30 Apr 2025</div>
    </div>
  );
}
