...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0A1628] overflow-hidden">
      <TopBar perspective={perspective} setPerspective={setPerspective} />
      <div className="flex flex-1 overflow-hidden">
        <Sidebar perspective={perspective} onToast={msg => addToast(msg, 'info')} />
        <main className="flex-1 overflow-hidden relative">
          <AnimatePresence mode="wait">
            ...
            >
              {perspective === 'strategic' && <StrategicView onToast={addToast} />}
